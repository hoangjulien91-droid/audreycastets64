...
export const metadata: Metadata = {
  ...
  description:
    "Une approche à 360° combinant soutien psychologique et investigation rigoureuse pour l'accompagnement global des victimes.",
  alternates: {
...
export default function PartnershipPage() {
  return (
    <>
      <BreadcrumbJsonLd items={[{ name: "Accueil", url: "/" }, { name: "Partenariat" }]} />
