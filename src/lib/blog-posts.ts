...
export const blogPosts: BlogPost[] = [
  {
    ...
    summary:
      "A critical-severity vulnerability in React Server Components affecting React 19 and frameworks including Next.js.",
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: ["These packages are included in the following frameworks and bundlers:"],
        list: {
          type: "bullet",
          items: [
