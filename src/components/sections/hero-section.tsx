...
export default function HeroSection() {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="relative min-h-screen overflow-hidden bg-gradient-to-br from-background via-muted/30 to-accent/20"
    ...
    >
      ...
      <div className="container relative z-10 pt-32 pb-20 sm:pt-40 sm:pb-28 lg:pt-48 lg:pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <motion.div
              {...(shouldReduceMotion ? {} : { initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 } })}
              transition={{ duration: shouldReduceMotion ? 0 : 1, delay: shouldReduceMotion ? 0 : 0.4 }}
              className="relative w-full h-full"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 to-accent/20 rounded-3xl blur-2xl" aria-hidden="true" />
              ...
              <motion.div
                {...(shouldReduceMotion ? {} : { initial: { opacity: 0, x: 50 }, animate: { opacity: 1, x: 0 } })}
                transition={{ duration: shouldReduceMotion ? 0 : 0.8, delay: shouldReduceMotion ? 0 : 1.2 }}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-2xl font-bold text-foreground" aria-label="Plus de 5 années d'expérience">+5</p>
